...
function article_add(title, url, w, h) {
	/*var title=['仓库','品牌','材质','型号','色号','框型','销售价格'];
	var type=['text','select','text','text','text','text','text'];
	var id=['warehouse','brand','material','model','color','boxType','price']
	...
	var content_title=[
		['仓库','品牌','材质','型号','色号','框型','销售价格'],
		['单位名称','地址','联系人','电话','入库价格','当前欠款']
	];
	var content_type=[
		['text','select','text','text','text','text','text'],
		['text','text','text','text','text','text']
	];
	var content_id=[
		['warehouse','brand','material','model','color','boxType','price'],
...
$('#brand,#model,#chip,#sex,#conversion,#price').on('blur', function() {
